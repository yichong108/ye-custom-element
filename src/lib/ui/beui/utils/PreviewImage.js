...
export default previewImages = (src, list, cb) =>
  new PreviewImage(src, list, cb);
...
class PreviewImage {
  ...
  deviceSupportUninstall() {
    ...
    off(this.btnDom, "click", (e) =>
      this.clickBtnHandler(e.target.dataset.type)
    );
